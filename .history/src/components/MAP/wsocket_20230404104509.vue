                ...
                <a-row :gutter="48">
                    ...
                    <a-form-item style="color:green" label="标准数据源">
                        ...
                        >
                            ...
                            <vertical-align-top-outlined v-if="loading"/>{{ file1.name}}
                        </a-upload>
...
export default{
    ...
    methods: {
        ...
        onSubmit() {
            ...
            form.append('file_list', this.file2)
            console.log(form)
            console.log('file:'+form.has('file'))
            // this.visiable=false //测试
            this.$axios.post('http://localhost:8121/mapping/map',form,"Content-Type": "multipart/form-data;charset=utf-8")
            .then(res=>{
                console.log(res)
                if(res.status==200){
        ...
        uploadForm1(filelist1) {
            ...
            this.file1=filelist1.file
        },
        uploadForm2(filelist2) {
            this.file2=filelist2.file
        },
