<template>
    ...
    <a-layout  class="top" style="position:fixed;right: 0;left:0;bottom: 0%;height:94%;z-index: 999;">   
        <canvass></canvass>
        <a-layout-content style="padding: 0 50px; position:fixed;left:10%;right: 10%;bottom: 5%;top:10%;width:">
          <a-breadcrumb style="margin: 16px 0">
            <a-breadcrumb-item>MAP</a-breadcrumb-item>
            <a-breadcrumb-item>{{ itemname1 }}</a-breadcrumb-item>

          </a-breadcrumb>
          <a-layout class="box-card" style="padding: 24px 0; background: rgba(255, 255, 255,0.6);height: 86%;">
