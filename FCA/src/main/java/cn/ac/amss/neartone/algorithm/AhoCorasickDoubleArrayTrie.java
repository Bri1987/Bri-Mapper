...
package cn.ac.amss.neartone.algorithm;
...
public class AhoCorasickDoubleArrayTrie<V> implements Serializable
{
    ...
    {
        int newCurrentState = transitionWithRoot(currentState, character);  // �Ȱ�success��ת
        while (newCurrentState == -1) // ��תʧ�ܵĻ�����failure��ת
        {
...
//    }
    ...
    private class Builder
    {
        ...
        private int fetch(State parent, List<Map.Entry<Integer, State>> siblings)
        {
            ...
            {
                State fakeNode = new State(-(parent.getDepth() + 1));  // �˽ڵ���parent���ӽڵ㣬ͬʱ�߱�parent�����
        ...
        private int insert(List<Map.Entry<Integer, State>> siblings)
        {
            ...
            outer:
            // ��ѭ�����Ŀ�����ҳ�����base[begin + a1...an]  == 0��n�����пռ�,a1...an��siblings�е�n���ڵ�
            while (true)
            {
                pos++;
                ...
                begin = pos - siblings.get(0).getKey(); // ��ǰλ�����һ���ֵܽڵ�ľ���
                if (allocSize <= (begin + siblings.get(siblings.size() - 1).getKey()))
                {
                    // progress can be zero // ��ֹprogress�����������
            ...
            if (1.0 * nonzero_num / (pos - nextCheckPos + 1) >= 0.95)
                nextCheckPos = pos; // ��λ�� next_check_pos ��ʼ�� pos �䣬�����ռ�õĿռ���95%���ϣ��´β���ڵ�ʱ��ֱ�Ӵ� pos λ�ô���ʼ����
            used[begin] = true;
            ...
            for (Map.Entry<Integer, State> sibling : siblings)
            {
                ...
                if (fetch(sibling.getValue(), new_siblings) == 0)  // һ���ʵ���ֹ�Ҳ�Ϊ�����ʵ�ǰ׺����ʵ����Ҷ�ӽڵ�
                {
