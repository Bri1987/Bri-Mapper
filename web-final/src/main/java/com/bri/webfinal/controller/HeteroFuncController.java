...
public class HeteroFuncController
{
    ...
    public JsonData mysqlToPostgresql(@RequestParam("id1")int id1, @RequestParam("id2")int id2, @RequestParam("file1")MultipartFile file1,@RequestParam("file2")MultipartFile file2,@RequestParam("table_name")String table_name) throws IOException, SQLException, ParserConfigurationException, SAXException {
