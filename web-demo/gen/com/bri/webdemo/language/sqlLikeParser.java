...
public class sqlLikeParser extends Parser {
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, "INT", "IDent", "WS"
		};
	}
	...
	public static class InsertContext extends AddDataContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).enterInsert(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).exitInsert(this);
		}
		@Override
	...
	public static class Meta_lineContext extends LineContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).enterMeta_line(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).exitMeta_line(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Line_contentContext extends ContentContext {
		...
		public List<TerminalNode> INT() { return getTokens(sqlLikeParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(sqlLikeParser.INT, i);
		}
		public Line_contentContext(ContentContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).enterLine_content(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof sqlLikeListener ) ((sqlLikeListener)listener).exitLine_content(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
